...
.proc draw_indicator_T1
	...
	bne :+
		jsr draw_spacebar_indicator_T1
		rts
 :
	lda #KEYBOARD_IDX_NEXT_PAGE
	cmp screen_keyboard_index
	bne :+
		jsr draw_arrow_indicator_T1
		rts
 :
...
.proc draw_spacebar_indicator_T1
	;	x var,x offset, is x subtracting, y var, y offset, is y subtracting, sprite, index
...
.proc draw_selected_line_indicator_T3
	jsr get_color_from_selected_line_T2
	lda zp_temp_0
	sta zp_temp_3
